...
class OnGoingWorkoutState with _$OnGoingWorkoutState {
  ...
  factory OnGoingWorkoutState.ExerciseInProgress(int currentExerciseIndex, String imgUrl, String exerciseName, int setCount, int currentSet, {int? repCount, int? secondsLeft}) = _Exercise;
}
